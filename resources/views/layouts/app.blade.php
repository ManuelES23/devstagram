            ...
            @auth
                <nav class="flex gap-2 items-center">
                    ...
                    <a href="{{ route('post.create') }}"
                        class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded-2xl text-sm uppercase font-bold cursor-pointer">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="font-bold uppercase text-gray-600 cursor-pointer">Cerrar
                            Sesión</button>
                    </form>
                </nav>
            @endauth
